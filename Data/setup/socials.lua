-- SOCIALS.LUA
-- This is the socials data file
-- Revised: 2009.10.30
-- Author: Jason Murdick
f = loadfile(GetAppSetting("dataPath") .. "\\modules\\module_base.lua")();


systemLog("=================== REALMMUD SETUP - SOCIAL COMMANDS ===================");
newSocial = createSocial("Accuse");
...
--OthersNoArg $n ACKS at $l big mistake.
--CharFound   You ACK $k.
--OthersFound $n ACKS $n.
--VictFound   $n ACKS you.
--CharAuto    You ACK yourself.
--OthersAuto  $n ACKS $kself.  Must be a bad day.
--#SOCIAL_END
--
--#SOCIAL
--Name        addict
--CharNoArg   You stand and admit to all in the Space, 'Hi, I'm $n, and I'm a mud addict.'
--OthersNoArg $n stands and says, 'Hi, I'm $n, and I'm a mud addict.'
--CharFound   You tell $k that you are addicted to $l love.
--OthersFound $n tells $n that $j is addicted to $l love.
--VictFound   $n tells you that $j is addicted to your love.
--CharAuto    You stand and admit to all in the Space, 'Hi, I'm $n, and I'm a mud addict.'
...
--OthersAuto  $n adores $kself soooo much!
--#SOCIAL_END
--
--#SOCIAL
--Name        again
--CharNoArg   You think, "not again!"
--OthersNoArg $n hits $l head on a tree and cries, "Not AGAIN!?"
...
--OthersAuto  $n makes a mental note to do what $j just did more often!
--#SOCIAL_END
--
--#SOCIAL
--Name        agree
...
--CharFound   You agree with $k.
--OthersFound $n agrees with $n.
--VictFound   $n agrees with you.
--CharAuto    Well I hope you would agree with yourself!
--OthersAuto  $n agrees with $kself, of course.
--#SOCIAL_END
--
--#SOCIAL
--Name        ahem
--CharNoArg   You clear your throat loudly and look slowly around.
--OthersNoArg $n clears $l throat loudly and looks around.
--CharFound   You cock an eyebrow at $n and clear your throat.
--OthersFound $n cocks an eyebrow at $n and clears $l throat.
--VictFound   $n cocks an eyebrow at you and clears $l throat.
--CharAuto    You quickly clear your throat and glance around nervously.
--OthersAuto  $n suddenly clears $l throat and glances around nervously.
--#SOCIAL_END
--
--#SOCIAL
--Name        alfalfa
--CharNoArg   You hear a strange voice yell 'Spaaanky!'
--OthersNoArg $n's eyes look puzzled as $j hears strange voices...
...
--OthersNoArg $n apologizes for $l rude behavior.
--CharFound   You apologize to $k.
--OthersFound $n apologizes to $n.
--VictFound   $n apologizes to you.
--CharAuto    You apologize to yourself.
--OthersAuto  $n apologizes to $kself.  Hmmmm.
--#SOCIAL_END
--
--#SOCIAL
--Name        applaud
...
--CharFound   You clap at $l actions.
...
--OthersAuto  $n applauds at $kself.  Boy, are we conceited!
--#SOCIAL_END
--
--#SOCIAL
--Name        arf
...
--CharAuto    You run around the Space exclaiming, "Arf! Arf! Arf!"
--OthersAuto  $n runs around the Space exclaiming, "Arf! Arf! Arf!"
--#SOCIAL_END
--
--#SOCIAL
--Name        babble
...
--CharFound   You begin to babble at $n and $j can't understand a word you are saying.
...
--OthersNoArg $n strikes a pose in $l most babe-like style!
...
--OthersAuto  $n seems to think that $j is a babe!
--#SOCIAL_END
--
--#SOCIAL
--Name        baffle
--CharNoArg   You scrunch up your face cuz you are totally baffled!
--OthersNoArg $n scrunches up $l face cuz $j is totally baffled!
--CharFound   You scrunch up your face at $n cuz $l behavior totally baffles you!
--OthersFound $n scrunches up $l face at $n cuz $n is totally baffled by $n!
--VictFound   $n scrunches up $l face at you cuz you totally baffle $k!
--CharAuto    You baffle yourself.
--OthersAuto  $n seems to be baffled by $l own thoughts.
--#SOCIAL_END
--
--#SOCIAL
--Name        bagel
...
--OthersAuto  $n pulls a golden brown bagel from the fire and pops it into $l mouth. Yummy!
--#SOCIAL_END
--
--#SOCIAL
--Name        bah
...
--CharFound   You sneak up on $n, and sing, 'DAAAAAYO!'  Bananas are dancing before $l eyes.
--OthersFound $n sneaks up behind $n and screams 'DAAAAAAAAAAAAAY-O' at the top of $l lungs.. Bananas are dancing before $l eyes now.
...
--OthersAuto  $n begins to projectile vomit over everything in the Space!
--#SOCIAL_END
--
--#SOCIAL
--Name        bark
...
--OthersFound $n looks at $n, then bashfully stares at $l feet.
--VictFound   $n looks up at you, then bashfully traces figure eights with $l foot.
...
--OthersNoArg $n announces that $j'll be back later.
--CharFound   You inform $k that you will be back later.
--OthersFound $n informs $n that $j will be back later
--VictFound   $n informs you that $j will be back later
--CharAuto    You mumble to yourself that you'll be back later.
--OthersAuto  $n mumbles to $kself that $j'll be back later.
--#SOCIAL_END
--
--#SOCIAL
--Name        bearhug
...
--CharFound   You bearhug $k.
--OthersFound $n bearhugs $n.  Some ribs break.
--VictFound   $n bearhugs you.  Wonder what's coming next?
--CharAuto    You bearhug yourself.
--OthersAuto  $n bearhugs $kself.
--#SOCIAL_END
--
--#SOCIAL
--Name        beckon
--CharNoArg   Psst, c'mon.  Anyone?
--OthersNoArg $n beckons to the air.  That might prove wise if $j gets stranded in a medieval submarine.
--CharFound   You beckon $n follow you through rain, snow, dragons' lairs and even *gulp* lag.
--OthersFound $n beckons $n follow $k.  You smell a rat.
--VictFound   $n beckons you follow $k through rain, snow, dragons' lairs and even *gulp* lag.
...
--OthersAuto  $n draws $kself a beer.
--#SOCIAL_END
--
--#SOCIAL
--Name        beg
...
--OthersFound $n gets on $l knees begging for a favor from $n..how unbecoming.
...
--OthersFound $n grins evilly at $n while brandishing $l weapon!
--VictFound   $n grins evilly at you, brandishing $l weapon.
--CharAuto    I really don't think you want to do that...
--OthersAuto  $n is so desperate for exp that $j tries to decapitate $kself!
--#SOCIAL_END
--
--#SOCIAL
--Name        bkiss
--CharNoArg   Blow a kiss to whom?
--OthersNoArg $n blows at $l hand.
--CharFound   You blow a kiss to $k.
...
--OthersAuto  $n blows a kiss to $kself.  Weird.
--#SOCIAL_END
--
--#SOCIAL
--Name        blank
--CharNoArg   You get a blank look on your face.
--OthersNoArg $n gets a blank look on $l face.
...
--CharFound   You look at $n and give $k a real blast.
--OthersFound $n looks at $n and gives $k a real blast!
--VictFound   $n looks at you and gives you a real blast!
--CharAuto    Do you really think that's polite?
--OthersAuto  $n looks as though $j wants a blast.
--#SOCIAL_END
--
--#SOCIAL
--Name        bleed
--CharNoArg   You bleed all over the Space!
--OthersNoArg $n bleeds all over the Space!  Get out of $l way!
--CharFound   You bleed all over $k!
...
--OthersAuto  $n bleeds all over $kself.
--#SOCIAL_END
--
--#SOCIAL
--Name        bleh
--CharNoArg   You grimace as if tasting something hideous and say "BLEH!"
--OthersNoArg $n sticks $l tongue out and says "Bleh!"
...
--CharFound   You blink at $k in confusion.
--OthersFound $n blinks at $n in confusion.
--VictFound   $n blinks at you in confusion.
--CharAuto    You are sooooooooooooo confused
--OthersAuto  $n blinks at $kself in complete confusion.
--#SOCIAL_END
--
--#SOCIAL
--Name        blownose
--CharNoArg   You blow your nose loudly.
--OthersNoArg $n blows $l nose loudly.
--CharFound   You blow your nose on $l shirt.
--OthersFound $n blows $l nose on $n's shirt.
--VictFound   $n blows $l nose on your shirt.
--CharAuto    You blow your nose on your shirt.
--OthersAuto  $n blows $l nose on $l shirt.
--#SOCIAL_END
--
--#SOCIAL
--Name        blunk
--CharNoArg   You try to blink but blunk instead.
--OthersNoArg $n tries to blink but $j blunks instead.
...
--CharFound   You get all flustered up seeing $k.
--OthersFound $n blushes as $j sees $n here.
--VictFound   $n blushes as $j sees you here.  Such an effect on people!
--CharAuto    You blush at your own folly.
--OthersAuto  $n blushes as $j notices $l boo-boo.
--#SOCIAL_END
--
--#SOCIAL
--Name        boggle
...
--CharFound   You boggle in complete incomprehension of $l actions.
...
--OthersAuto  $n bonks $kself! Whatta loon.. eh?
--#SOCIAL_END
--
--#SOCIAL
--Name        bounce
...
--OthersAuto  $n attempts to squeeze some thoughts from $l noggin, making the gods themselves, terrorized by this display, run.
--#SOCIAL_END
--
--#SOCIAL
--Name        brb
...
--CharFound   You announce to $k that you will be right back.
...
--OthersAuto  $n mumbles to $kself, 'I'll be right back, won't I?'
--#SOCIAL_END
--
--#SOCIAL
--Name        bristle
--CharNoArg   You clench your teeth and bristle with anger.
--OthersNoArg $n clenches $l teeth and bristles with anger.
...
--OthersAuto  $n bristles at $kself and $l foolishness.
--#SOCIAL_END
--
--#SOCIAL
--Name        brownie
...
--OthersAuto  $n gives $kself a brownie, $j might be a BIT strange.
--#SOCIAL_END
--
--#SOCIAL
--Name        brush
...
--CharFound   You brush out $l hair for $k.  Very thoughtful.
--OthersFound $n brushes $n's hair for $k.  Looks better now.
--VictFound   $n brushes out your hair.  How nice of $k.
--CharAuto    You brush out your hair.  There - much better.
--OthersAuto  $n brushes out $l hair.  Looks much better now.
--#SOCIAL_END
--
--#SOCIAL
--Name        bungee
...
--CharFound   You whip out a bungee cord, stick it on $n, and kick $k off the mud!
--OthersFound $n whips out a bungee cord, sticks it on $n, and pushes $k off the mud.
...
--OthersAuto  $n connects itself to a bungee cord and jumps off the mud! Phew, you were hoping $j would leave soon!
--#SOCIAL_END
--
--#SOCIAL
--Name        bunny
...
--OthersAuto  $n looks as though $j misses $l little bunny.  Aww...
--#SOCIAL_END
--
--#SOCIAL
--Name        burp
...
--CharFound   You burp loudly to $k in response.
...
--OthersAuto  $n burps at $kself.  What a sick sight.
--#SOCIAL_END
--
--#SOCIAL
--Name        bye
--CharNoArg   You say goodbye to all in the Space.
--OthersNoArg $n says goodbye to everyone in the Space.
...
--OthersAuto  $n says goodbye to $kself.  Is $j contemplating suicide?
--#SOCIAL_END
--
--#SOCIAL
--Name        cackle
--CharNoArg   You throw back your head and cackle with insane glee!
--OthersNoArg $n throws back $l head and cackles with insane glee!
--CharFound   You cackle gleefully at $n.
--OthersFound $n cackles gleefully at $n.
--VictFound   $n cackles gleefully at you.  Better keep your distance from $k.
--CharAuto    You cackle at yourself.  Now, THAT'S strange!
--OthersAuto  $n is really crazy now!  $j cackles at $kself.
--#SOCIAL_END
--
--#SOCIAL
--Name        caress
--CharNoArg   Who needs to be caressed?
--OthersNoArg $n caresses $l hands softly because no one else will.
--CharFound   You gently caress $l face.
...
--OthersAuto  $n gently caresses $l face.
--#SOCIAL_END
--
--#SOCIAL
--Name        catnap
--CharNoArg   You curl into a tiny ball and go to sleep.
--OthersNoArg $n curls $kself into a tiny ball and goes to sleep.
--CharFound   You curl up in $l lap and go to sleep.
...
--OthersAuto  $n curls $kself into a tiny ball and goes to sleep.
--#SOCIAL_END
--
--#SOCIAL
--Name        challenge
...
--OthersAuto  $n tries to challenge $kself, how odd.
--#SOCIAL_END
--
--#SOCIAL
--Name        charge
...
--OthersFound $n ducks $l head, stamps $l foot three times and charges toward $n.
--VictFound   $n lowers $l head, stamps $l foot three times and runs toward you screaming.. 
--CharAuto    You scream, 'Geronimo!,' as you chase yourself about the Space.
--OthersAuto  $n screams, 'Geronimo!,' as they chase themself about the Space.
--#SOCIAL_END
--
--#SOCIAL
--Name        cheer
...
--CharAuto    Go me!
--OthersAuto  $n thinks $j's pretty damned neat.  Go $n!!!
--#SOCIAL_END
--
--#SOCIAL
--Name        cheesecake
--CharNoArg   You wish you had some cheesecake....yummmm.
--OthersNoArg $n wishes $j had some cheesecake....yummmm.
...
--OthersAuto  $n starts thinking $j is a cheesecake and begins to nibble on $kself.  Yuck!
--#SOCIAL_END
--
--#SOCIAL
--Name        chicken
--CharNoArg   You peer around the Space for cowards.
...
--OthersAuto  $n shamefully admits $j's a chicken.
--#SOCIAL_END
--
--#SOCIAL
--Name        chill
--CharNoArg   You mutter the words "chill out" to no one in particular.
--OthersNoArg $n stares off into space and mutters "chill out" to $l imaginary friends. They must be on crack or something.
...
--CharFound   You chuckle at $l joke.
...
--OthersAuto  $n chuckles at $l own joke, since none of you would.
--#SOCIAL_END
--
--#SOCIAL
--Name        cigar
--CharNoArg   You light up a big cigar. All the females leave the Space.
--OthersNoArg $n lights up a big cigar. All the females leave the Space.
--CharFound   You give $n a big cigar and light it for $k. All the females flee the Space.
--OthersFound $n gives a big cigar to $n and light it for $k. All the females flee the Space.
--VictFound   $n gives you a big cigar and lights it for you. All the females flee the Space.
--CharAuto    You give a cigar to yourself, are you feeling ok?
--OthersAuto  $n gives $kself a cigar.  Hmmmmm.
--#SOCIAL_END
--
--#SOCIAL
--Name        clap
--CharNoArg   You clap your hands together.
--OthersNoArg $n shows $l approval by clapping $l hands together.
--CharFound   You clap at $l performance.
--OthersFound $n claps at $n's performance.
--VictFound   $n claps at your performance.
--CharAuto    You clap at your own performance.
--OthersAuto  $n claps at $l own performance.
--#SOCIAL_END
--
--#SOCIAL
--Name        clue
--CharNoArg   You want to give a clue to yourself? You must have no clue, eh?
--OthersNoArg $n thinks $j has a clue ... but $j is wrong.
--CharFound   You try to give $n a clue ... but $j is totally clueless ... whadda dork, eh?
--OthersFound $n tries to give $n a clue ... but $j is totally clueless ... whadda dork, eh?
--VictFound   $n tries to give you a clue ... $j must think you are totally clueless, eh?
--CharAuto    You want to give yourself a clue? Bonehead!
--OthersAuto  $n tries to give themself a clue ... but $j is totally clueless, eh?
--#SOCIAL_END
--
--#SOCIAL
--Name        coffee
--CharNoArg   You wish someone would give you a cup of coffee.
--OthersNoArg $n wishes someone would offer $k a cup of coffee.
...
--OthersNoArg $n combs $l hair, how dashing!
...
--OthersAuto  $n tries to comb $l tangled hair.
--#SOCIAL_END
--
--#SOCIAL
--Name        comfort
--CharNoArg   Do you feel uncomfortable?
--OthersNoArg $n tries to comfort $kself, $j looks uncomfortable.
--CharFound   You comfort $k.
--OthersFound $n comforts $n.
--VictFound   $n comforts you.
--CharAuto    You make a vain attempt to comfort yourself.
--OthersAuto  $n has no one to comfort $k but $kself.
--#SOCIAL_END
--
--#SOCIAL
--Name        cookie
...
--OthersAuto  $n tries to give a cookie to $kself. How selfish!
--#SOCIAL_END
--
--#SOCIAL
--Name        cough
...
--CharFound   You cough loudly.  It must be $l fault, $j gave you this cold.
--OthersFound $n coughs loudly, and glares at $n, like it is $l fault.
--VictFound   $n coughs loudly, and glares at you.  Did you give $k that cold?
--CharAuto    You cough loudly.  Why don't you take better care of yourself?
--OthersAuto  $n coughs loudly.  $n should take better care of $kself.
--#SOCIAL_END
--
--#SOCIAL
--Name        cower
...
--CharFound   You cower in the corner at the sight of $k.
...
--OthersAuto  $n cowers in the corner.  What is wrong with $k now?
--#SOCIAL_END
--
--#SOCIAL
--Name        cringe
...
--CharFound   You cringe away from $k.
--OthersFound $n cringes away from $n in mortal terror.
--VictFound   $n cringes away from you.
--CharAuto    I beg your pardon?
--OthersAuto  $n cringes away from $kself, that has to be difficult.
--#SOCIAL_END
--
--#SOCIAL
--Name        croak
--CharNoArg   You attempt to sing, but it sounds more like a croak. Take lessons :P
--OthersNoArg $n is in obvious need of singing lessons as $k begins to croak out a song!
--CharFound   You begin croaking out the song "Row Row Row Your Boat" to $n. Hmmm.
--OthersFound $n begins to croak to $n. You realize that $k is attempting to sing "Row Row Row Your Boat". Ick.
--VictFound   $n looks at you and begins to croak out a song. Ugh!
--CharAuto    You hum to yourself.
--OthersAuto  $n begins to croak to $kself.
--#SOCIAL_END
--
--#SOCIAL
--Name        croon
--CharNoArg   You croon out a tune to everyone in the Space.
--OthersNoArg $n croons out a tune to everyone in the Space.
...
--CharFound   You give $n a look so cruel that $j fears for $l life!
--OthersFound $n gives $n a look so cruel that $j fears for $l life!
...
--CharFound   You hold two fingers up at $k and say, 'I'm crushing your head!'
...
--OthersAuto  $n crushes $kself into the ground.  OUCH!
--#SOCIAL_END
--
--#SOCIAL
--Name        cry
...
--CharFound   You swear at $k.
--OthersFound $n swears at $n.
--VictFound   $n swears at you!  Where are $l manners?
--CharAuto    You swear at your own mistakes.
--OthersAuto  $n starts swearing at $kself.  Why don't you help?
--#SOCIAL_END
--
--#SOCIAL
--Name        curtsey
...
--OthersAuto  $n curtseys to $kself, since no one is paying attention to $k.
--#SOCIAL_END
--
--#SOCIAL
--Name        cute
--CharNoArg   You flash your dimples thinking you are as cute as Marian.
--OthersNoArg $n flashes $l dimples. $n thinks $j is as cute as Marian.
--CharFound   You look at $n and wish $j was as cute as Marian.
--OthersFound $n looks at $n and wishes $j was as cute as Marian.
...
--OthersNoArg $n tries to break dance, but nearly breaks $l neck!
--CharFound   You sweep $k into a romantic waltz.
...
--CharFound   You attempt to dazzle $n as you flash $k a huge smile and stand straight.
--OthersFound A flash of white nearly blinds you as $n smiles.
--VictFound   $n has the most amazing teeth , you think as $j flashes you an incredible smile.
--CharAuto    If you can't kill them, perhaps this dazzling smile will work?
--OthersAuto  $n dazzles everyone with $l smile.
--#SOCIAL_END
--
--#SOCIAL
--Name        dive
...
--CharFound   You dive behind $k and hide.
...
--OthersNoArg $n slaps $kself on the head and yells, "DOH!"
...
--OthersAuto  $n keeps hitting $kself in the head and uttering, "DOH!"
--#SOCIAL_END
--
--#SOCIAL
--Name        douse
--CharNoArg   Douse who?
--OthersNoArg $n mutters something about the heat and pours cold water over $kself.  Great, now there's a a large puddle of water near you.
--CharFound   You slowly and methodically dump a bucket of ice over $n
--OthersFound Smirking, $n pours ice water on $n!  That should cool $k off!
--VictFound   $n has doused you with ice water. That should calm you.
--CharAuto    Hmmm...did that cool you off?
--OthersAuto  Complaining of the heat, $n pours cold water over $l head.
--#SOCIAL_END
--
--#SOCIAL
--Name        doze
--CharNoArg   Your chin drops to your chest as you suddenly get dozy.
--OthersNoArg $n's eyes get heavy as $l head drops in a sudden doze.
--CharFound   You weave your hands in a hypnotic pattern trying to make $n sleepy.
--OthersFound $n weaves $l hands in a hypnotic pattern, attempting to put $n to sleep.
--VictFound   $n weaves $l hands in a hypnotic pattern. You start to feel dozy.
--CharAuto    You weave your hands in an odd pattern, suddenly finding yourself dozing off.
--OthersAuto  $n weaves $l hands in an odd pattern, looking surprized to be dozing off.
--#SOCIAL_END
--
--#SOCIAL
--Name        drool
--CharNoArg   You drool on yourself.
--OthersNoArg $n drools on $kself.
...
--CharFound   You duck behind $k.  Whew!  That was close!
...
--OthersAuto  $n tries to duck behind $kself.  $n needs help getting untied now.
--#SOCIAL_END
--
--#SOCIAL
--Name        eek
...
--VictFound   $n grabs $l mousetrap, wishing only despair on your foul, rodent soul.
--CharAuto    Oh no! $n the rabid rodent! Run!!!
--OthersAuto  $n begins to nibble on $l mousetrap. Stranger things...
--#SOCIAL_END
--
--#SOCIAL
--Name        eep
...
--OthersNoArg $n looks around for someone to hold close to $k.
--CharFound   You hold $k in a warm and loving embrace.
...
--OthersAuto  $n holds $kself in a warm and loving embrace.  $j looks pretty silly.
--#SOCIAL_END
--
--#SOCIAL
--Name        evilgrin
...
--CharFound   You grin so evilly at $k that $l alignment drops to -1000.
--OthersFound $n grins so evilly at $n that $l alignment drops to -1000.
...
--OthersAuto  $n grins so evilly that $l alignment drops to -1000.
--#SOCIAL_END
--
--#SOCIAL
--Name        excellent
--CharNoArg   You grin and say 'Excellent, Party on dude!'
--OthersNoArg $n grins and says 'Excellent, Party on dude!'
...
--OthersAuto  $n looks like $j is enoying a good thought.
--#SOCIAL_END
--
--#SOCIAL
--Name        eyebrow
...
--CharFound   You raise an eyebrow at $k.
...
--OthersAuto  $n raises an eyebrow at $kself.  That must have hurt!
--#SOCIAL_END
--
--#SOCIAL
--Name        faint
--CharNoArg   You feel dizzy and hit the ground like a board.
--OthersNoArg $n's eyes roll back in $l head and $j crumples to the ground.
--CharFound   You faint into $l arms.
...
--OthersAuto  $n looks down at $l condition and faints dead away.
--#SOCIAL_END
--
--#SOCIAL
--Name        fakerep
...
--VictFound   $n takes one look at you and is overcome by fear. $n's knees begin to knock and $l legs buckle.
--#SOCIAL_END
--
--#SOCIAL
--Name        fiddledeedee
...
--CharFound   You tell $k, 'Fiddle-dee-dee!'
--OthersFound $n looks at $k and says, 'Fiddle-dee-dee!'
--VictFound   $n looks at you and says, 'Fiddle-dee-dee!'
--CharAuto    You mutter to yourself. Fiddle-dee-dee.
--OthersAuto  $n mutters to $kself. Fiddle-dee-dee.
--#SOCIAL_END
--
--#SOCIAL
--Name        flex
--CharNoArg   You flex.
--OthersNoArg $n flexes. Must think $j's buff.
--CharFound   You flex for $k. Impressive!
...
--CharFound   You flip $k over your shoulder.
--OthersFound $n flips $n over $l shoulder.
--VictFound   $n flips you over $l shoulder.  Hmmmm.
--CharAuto    You tumble all over the Space.
...
--OthersAuto  $n flirts with $kself.  Hoo boy.
--#SOCIAL_END
--
--#SOCIAL
--Name        flutter
--CharNoArg   You flutter your eyelashes.
--OthersNoArg $n flutters $l eyelashes.
--CharFound   You flutter your eyelashes at $k.
--OthersFound $n flutters $l eyelashes in $n's direction.
--VictFound   $n looks at you and flutters $l eyelashes.
--CharAuto    You flutter your eyelashes at the thought of yourself.
--OthersAuto  $n flutters $l eyelashes at no one in particular.
--#SOCIAL_END
--
--#SOCIAL
--Name        fondle
...
--OthersFound $n starts fondling $n, maybe they should get a Space!
--VictFound   $n fondly fondles you.
--CharAuto    You start fondling yourself, lonely eh?
--OthersAuto  $n starts fondling $kself. Hey it's the 90's, it's allowed!
--#SOCIAL_END
--
--#SOCIAL
--Name        footrub
--CharNoArg   You glance around the Space looking for someone to rub your feet.
--OthersNoArg $n glances around the Space looking for someone to rub $l feet.
--CharFound   You ask $n to rub your tired feet.
--OthersFound $n asks $n to rub $l tired feet. Better leave before $j asks you.
--VictFound   $n asks you to rub $l tired feet. Better leave your gloves on.
--CharAuto    You rub your tired feet, waiting for a refresh.
--OthersAuto  $n rubs $l tired feet. $j sure could use a refresh.
--#SOCIAL_END
--
--#SOCIAL
--Name        french
...
--OthersAuto  $n makes an attempt at kissing $kself.
--#SOCIAL_END
--
--#SOCIAL
--Name        frolick
...
--OthersAuto  $n frowns at $kself.  Poor baby.
--#SOCIAL_END
--
--#SOCIAL
--Name        fstar
...
--OthersNoArg $n grits $l teeth and fumes with rage.
--CharFound   You stare at $k, fuming.
--OthersFound $n stares at $n, fuming with rage.
--VictFound   $n stares at you, fuming with rage!
--CharAuto    That's right - hate yourself!
--OthersAuto  $n clenches $l fists and stomps his feet, fuming with anger.
--#SOCIAL_END
--
--#SOCIAL
--Name        gag
...
--OthersAuto  $n attempts to gag $kself.
--#SOCIAL_END
--
--#SOCIAL
--Name        gasp
...
--CharFound   You gasp as you realize what $j did.
--OthersFound $n gasps as $j realizes what $n did.
--VictFound   $n gasps as $j realizes what you did.
--CharAuto    You look at yourself and gasp!
--OthersAuto  $n takes one look at $kself and gasps in astonisment!
--#SOCIAL_END
--
--#SOCIAL
--Name        gawk
--CharNoArg   You gawk at everyone around you.
--OthersNoArg $n gawks at everyone in the Space.
--CharFound   You gawk at $k.
--OthersFound $n gawks at $n.
--VictFound   $n gawks at you.
--CharAuto    You gawk as you think what you must look like to others.
--OthersAuto  $n is gawking again.  What is on $l mind?
--#SOCIAL_END
--
--#SOCIAL
--Name        gbhug
...
--OthersAuto  $n giggles at $kself.  $j must be nervous or something.
--#SOCIAL_END
--
--#SOCIAL
--Name        girn
...
--CharFound   You try to grin at $n, but $j gives you a funny look.
--OthersFound $n tries to grin at $n, but screws it up badly.
--VictFound   $n turns $l lips in a sad attempt at a lopsided grin.
--CharAuto    Your face becomes a ghastly mask as you fail to grin.
--OthersAuto  $n's face becomes a strange death mask as $l tries to grin.
--#SOCIAL_END
--
--#SOCIAL
--Name        gjob
--CharNoArg   You leap in the air and yell "Good Job!"
--OthersNoArg $n pats $kself on the back and smiles.
...
--OthersAuto  $n tries to praise $kself for a job well done.
--#SOCIAL_END
--
--#SOCIAL
--Name        glare
--CharNoArg   You glare at nothing in particular.
--OthersNoArg $n glares around $k.
--CharFound   You glare icily at $k.
...
--OthersAuto  $n glares at $l feet, what is bothering $k?
--#SOCIAL_END
--
--#SOCIAL
--Name        glower
...
--CharFound   You glower at $n in frustration over what $j said.
...
--OthersAuto  $n glowers at $kself. Maybe $j's having a bad day.
--#SOCIAL_END
--
--#SOCIAL
--Name        gnight
...
--CharFound   You give $n a soft goodnight kiss and wave to $k.
--OthersFound $n gives $n a soft goodnight kiss then waves to $k.
--VictFound   $n gives you a soft goodnight kiss and then waves to you.
--CharAuto    You say goodnight to yourself.
--OthersAuto  $n says goodnight to $kself, $j must really be tired.
--#SOCIAL_END
--
--#SOCIAL
--Name        gobble
--CharNoArg   You clear your throat and gobble several times.
--OthersNoArg $n clears $l throat and gobbles most musically.
--CharFound   You clear your throat and gobble profusely at $n.
--OthersFound $n clears $l throat and gobbles like a turkey at $n.
--VictFound   $n clears $l throat and gobbles like a turkey at you.
--CharAuto    Gobbling at yourself? Okaaaay then.
--OthersAuto  $n starts gobbling to $kself.  How odd.
--#SOCIAL_END
--
--#SOCIAL
--Name        goose
...
--CharFound   You congratulate $n with a big slap on $l back!
...
--OthersAuto  $n congratulates $kself. What a goof!
--#SOCIAL_END
--
--#SOCIAL
--Name        greet
--CharNoArg   You greet everyone in the Space.
...
--CharFound   You grin evilly at $k.
...
--OthersAuto  $n grins at $kself.  You must wonder what's in $l mind.
--#SOCIAL_END
--
--#SOCIAL
--Name        grip
--CharNoArg   You tighten your grip on your weapon, preparing for battle.
--OthersNoArg $n tightens $l grip on $l weapon, preparing for battle.
--CharFound   You grip your weapon, preparing for battle with $n!
--OthersFound $n tightens $l grip on $l weapon, preparing for battle with $n!
--VictFound   $n tightens $l grip on $l weapon, preparing for battle with you!
--CharAuto    You attempt to get a grip on yourself.
--OthersAuto  $n attempts to get a grip on $kself.
--#SOCIAL_END
--
--#SOCIAL
--Name        gripe
...
--VictFound   $n gripes non stop. Perhaps $l armor is a bit too tight?
...
--CharFound   You groan at the sight of $k.
...
--OthersAuto  $n groans as $j realizes what $j has done.
--#SOCIAL_END
--
--#SOCIAL
--Name        grope
...
--OthersAuto  $n starts groping $kself, maybe you should leave $k alone.
--#SOCIAL_END
--
--#SOCIAL
--Name        grovel
...
--OthersAuto  $n starts groveling to $kself, I think there might be a problem here.
--#SOCIAL_END
--
--#SOCIAL
--Name        growl
...
--OthersFound $n growls at $n.  Better leave the Space before the fighting starts.
--VictFound   $n growls at you.  Hey, two can play it that way!
--CharAuto    You growl at yourself.  Boy, do you feel bitter!
--OthersAuto  $n growls at $kself.  This could get interesting...
--#SOCIAL_END
--
--#SOCIAL
--Name        grumble
...
--OthersNoArg $n gulps nervously and loosens $l neckwear.
--CharFound   You loosen your neckwear and gulp nervously under $n's gaze.
--OthersFound $n loosens $l neckwear and gulps nervously at $n.
--VictFound   $n loosens $l neckwear and gulps nervously at you.
--CharAuto    You gulp nervously and loosen your neckwear.
--OthersAuto  $n gulps nervously and loosens $l neckwear.
--#SOCIAL_END
--
--#SOCIAL
--Name        hair
--CharNoArg   You run your fingers through your hair.
--OthersNoArg $n runs $l fingers through $l hair, how vain!
--CharFound   You run your fingers through $n's hair.
--OthersFound $n runs $l fingers through $n's hair, how sweet.
--VictFound   $n runs $l fingers through your hair soothingly.
...
--OthersAuto  $n yells, 'HAPPY HAPPY JOY JOY!!' Don't mind $k, $j's a bit looney.
--#SOCIAL_END
--
--#SOCIAL
--Name        haus
--CharNoArg   $n sighs and dreams of $l hero... Haus.
--OthersNoArg $n sighs and dreams of $l hero... Haus
--CharFound   Pret#SOCIAL_END~ing you're Haus, you flex and attempt to summon a pet named Balzhur.
--OthersFound $n imitates Haus and tries to summon a huge demon to attack you!
--VictFound   Your attempt to impress someone while pret#SOCIAL_END~ing to be Haus will surely not be met with favor from the Gods.
...
--#SOCIAL
--Name        hay
--CharNoArg   You look around the Space and ask everyone, "How are you?"
--OthersNoArg $n looks around the Space and asks everyone, "How are you?"
...
--#SOCIAL
--Name        hello
--CharNoArg   You say hello to everyone in the Space.
--OthersNoArg $n says hello to everyone in the Space.
--CharFound   You tell $n how truly glad you are to see $k.
--OthersFound $n tells $n 'Hi!'
--VictFound   $n tells you how truly glad $j is that you are here.
--CharAuto    You greet yourself enthusiastically.
--OthersAuto  $n greets $kself enthusiastically.  How odd.
--#SOCIAL_END
--
--#SOCIAL
--Name        hercules
--CharNoArg   You strut around, acting like Hercules.
--OthersNoArg $n struts around, acting like $j is Hercules.
--CharFound   You pose for $n, acting like you are Hercules.
--OthersFound $n poses for $n, acting like $j is Hercules.
--VictFound   $n poses for you, acting like $j is Hercules.
--CharAuto    You think you are Hercules!
--OthersAuto  $n seems to think $j's Hercules.
--#SOCIAL_END
--
--#SOCIAL
--Name        hfive
...
--OthersNoArg $n clasps $l feet behind $l back.~
--CharFound   You hold $n's foot in your hand.~
--OthersFound $n holds $n's foot in $l hand.~
--VictFound   $n holds your foot in $l hand. Awwww ... isn't $j sweet?~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        hhand~
--CharNoArg   You clasp your hands behind your back.~
--OthersNoArg $n clasps $l hands behind $l back.~
...
--OthersAuto  $n clasps $l hands behind $l back.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        hiccup~
...
--OthersAuto  $n bares $l teeth and hisses spitefully.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        hmm~
...
--CharFound   You gaze thoughtfully at $k and say 'Hmmm.'~
...
--OthersNoArg $n pulls out a huge hankie and honks $l nose loudly.~
--CharFound   You pull out a large hankie and honk your nose at $n.~
--OthersFound $n pulls out a large hankie and honks $l nose at $n.~
--VictFound   $n pulls out a large hankie and honks $l nose at you.~
--CharAuto    You want to honk yourself? Sounds illegal.~
--OthersAuto  $n tries to honk $kself. I'd be leery of $n.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        hop~
...
--OthersNoArg $n is thinking that $j is a real hoser.~
...
--OthersAuto  $n proudly proclaims $kself to be a hoser.  Now if $j could just find the bottle opener?~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        how~
...
--OthersAuto  $n asks $kself, "how could this happen to me?"~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        hrm~
...
--OthersAuto  $n shakes hands with $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        hthink~
--CharNoArg   You close your eyes and think happy thoughts.~
--OthersNoArg $n closes $l eyes and starts muttering happy thoughts, happy thoughts.~
--CharFound   You pat $n on $l back and say "Remember, happy thoughts."~
--OthersFound $n pats $n on $l back and says, "Remember, Happy Thoughts. Think of your happy place."~
...
--OthersAuto  $n is wandering around with a goofy look on $l face whispering "Happy Thoughts" to no one in particular.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        hug~
--CharNoArg   Hug whom?~
--OthersNoArg $n is looking for someone to hug, $j must be lonesome.~
--CharFound   You hug $k.~
--OthersFound $n hugs $n.~
--VictFound   $n hugs you.~
--CharAuto    You hug yourself.~
--OthersAuto  $n hugs $kself in a vain attempt to get fri#SOCIAL_END~ship.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        hum~
...
--CharFound   You hum a little ditty for $k.  Hmm Hmm Hmm Hmmmmmm.~
...
--OthersFound $n is obviously under mental duress as $j tries to act like Jade and slay you all with a smile.~
--VictFound   $n is dressed like Jade. Report $k at once for Impersonating a Goddess!~
--CharAuto    You dream of being Jadelike~
--OthersAuto  $n has had one too many magic mushSpaces and fancies $kself being Jadelike. Bwahahhahaha~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        jealous~
...
--OthersFound $n is jealous of $n for stealing $l love.~
--VictFound   $n is jealous of you for stealing $l love.~
--CharAuto    You are jealous of your own studliness.~
--OthersAuto  $n is jealous of $kself, what a dork.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        jest~
--CharNoArg   You smirk at nothing, and say 'Just kidding!' Time to log off?~
--OthersNoArg $n smirks at nothing, and says 'Just kidding!' Time for $k to log off.~
...
--OthersAuto  $n smirks at $kself, and says 'Just kidding!' By Thoric, $j has lost it.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        joy~
...
--OthersNoArg $n whips out $l flaming torches and begins to juggle them. Wow. What skill, what grace!~
--CharFound   You whip out your flaming torches and begin to juggle for $n. Won't $j think you're great NOW?  ~
--OthersFound $n whips out a bunch of flaming torches to begin $l juggling act. You wonder if this Space is non-flammable. Hmmm.~
--VictFound   $n gets a crazy look in $l eyes as $j pulls out some flaming torches and begins to juggle. You look around for a fire-extinguisher.~
...
--OthersAuto  $n pulls out some VERY sharp swords and begins to juggle them with a crazed look in $l eyes. Maybe its time to leave ... ~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        kiss~
...
--OthersAuto  $n thinks $j is a cute little kitten. Meeeeow.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        kkong~
--CharNoArg   You beat your chest and moan like the animal you are!~
--OthersNoArg $n beats $l chest and reveals $l true animal nature.~
--CharFound   You beat your chest to show $n what a brute you are!~
--OthersFound $n swings from a vine and beats $l chest to impress $n.~
--VictFound   $n jumps from vine to vine pounding $l chest in some ancient mating ritual.~
--CharAuto    You pound your chest to practice courting.~
--OthersAuto  $n beats $l chest to practice for an upcoming mating ritual.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        kneel~
...
--CharFound   You climb into $n's lap and cuddle up with $k.~
--OthersFound $n climbs into $n's lap and cuddles up with $k.~
...
--OthersAuto  $n looks awful funny trying to crawl up into $l own lap and cuddle.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        laugh~
...
--OthersAuto  $n loves $kself, can you believe it?~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        lust~
...
--OthersAuto  $n looks $kself up and down lustily.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        mad~
...
--OthersFound $n inquires of $n as to whether $j is aware that $j is mentally ill.~
...
--OthersAuto  $n mulls $l own ill mental health.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        maim~
...
--CharFound   You maim $k with your dull fingernails.~
--OthersFound $n raises $l hand and tries to maim $n to pieces.~
--VictFound   $n raises $l hand and paws at you.  You've been maimed!~
--CharAuto    You maim yourself with your dull fingernails.~
--OthersAuto  $n raises $l hand and maims $kself to pieces.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        manners~
...
--CharFound   You wonder where $n learned $l manners.~
--OthersFound $n wonders where $n learned $l manners.~
--VictFound   $n wonders where you learned your manners.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        marshmallow~
--CharNoArg   $n looks around fer a nice, fat, squishy, MARSHMALLOW to stick in $l hot chocolate!~
--OthersNoArg $n looks around fer a nice, fat, squishy, MARSHMALLOW to stick in $l hot chocolate!~
--CharFound   You point at $n and pinching $l widdle, cute cheek, say 'Mmm you look as scrumptious as a marshmallow!'~
...
--OthersAuto  $n wraps $l body up into a little ball and dives into the hot chocolate yelling, 'Marshmallows away!!!'~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        massage~
...
--OthersAuto  $n gives a show on yoga positions, trying to massage $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        mean~
...
--CharFound   You give $n the meanest look $j has ever seen!~
--OthersFound $n gives $n the meanest look $j has ever seen!~
...
--CharFound   You have melted into $l arms!~
...
--OthersAuto  $n wishes $j could trade men for EQ.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        meow~
--CharNoArg   MEOW.~
--OthersNoArg $n meows.  What's $j going to do next, wash $kself with $l tongue?~
--CharFound   You meow at $k, hoping $j will give you some milk.~
--OthersFound $n meows at $n, hoping $j will give $k some milk. ~
--VictFound   $n meows at you.  Maybe $j wants some milk.~
...
--OthersNoArg $n pours $kself a glass of cold creamy milk and gulps it down.~
--CharFound   You pour a glass of cold creamy milk for $n and give it to $k.~
...
--OthersNoArg $n's heart pines for a special someone $j misses so much. Awwwww.~
--CharFound   You tell $n that your heart has been aching cuz you've missed $k so much. Awww.~
--OthersFound $n tells $n that $l heart has been aching cuz $j missed $k so much. Awww.~
--VictFound   $n tells you that $l heart has been aching cuz $j missed you so much. Awww.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        mistletoe~
--CharNoArg   You point at the mistletoe above your head, and pucker up.~
--OthersNoArg $n points to the mistletoe above $l head, and puckers up.~
...
--OthersAuto  $n points to the mistletoe above $l head, and puckers up.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        mmm~
...
--OthersAuto  $n thinks of $kself and says 'mmMMmmMMmmMMmm.'~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        moan~
...
--OthersAuto  $n is making a monkey out of $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        mooch~
...
--CharFound   You make cow noises at $k.  Mooooooooooooooooooo!~
...
--OthersNoArg $n howls at the moon. Is that fur on $l knuckles?~
--CharFound   You howl at $n. Feeling a little feral are we?~
--OthersFound $n howls at $n. Could be that $j is feeling a bit feral?~
--VictFound   $n howls at you. Could $j be feeling a bit feral?~
--CharAuto    Howling to yourself? The moon does seem a bit bright tonight..~
--OthersAuto  $n is howling to $kself.  Must be a bright moon tonight..~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        muffin~
...
--CharFound   You laugh at $k diabolically.  MUHAHAHAHAHAHA!..~
...
--OthersNoArg $n is mumbling under $l breath.~
--CharFound   You mumble to $n, hoping $j will listen.~
...
--OthersAuto  $n is mumbling something to $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        mutter~
...
--CharFound   You mutter to yourself and shake your head at $k.~
--OthersFound $n mutters distractedly and shakes $l head at $n.~
--VictFound   $n mutters distractedly and shakes $l head at you.~
--CharAuto    You mutter dithyrambically to yourself.~
--OthersAuto  $n mutters at $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        nag~
...
--CharFound   You nag $n. Nag $k like a hag!~
--OthersFound $n nags $n. Nags $k like a hag!~
...
--OthersNoArg $n nibbles nervously on $l fingernails.~
--CharFound   You nibble nervously on your nails.~
--OthersFound $n nibbles nervously on $l fingernails.~
--VictFound   $n nibbles nervously on your fingernails.  Yuck!~
--CharAuto    You nibble nervously on your nails.~
--OthersAuto  $n nibbles nervously on $l fingernails.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        nibble~
...
--OthersAuto  $n nibbles on $l OWN ear.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        nod~
...
--CharFound   You nod in agreement to $k.~
...
--OthersAuto  $n nods at $kself.  $j must be getting senile.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        nog~
--CharNoArg   You nog yourself!~
--OthersNoArg $n nogs $lself.~
--CharFound   You nog $n.~
--OthersFound $n nogs $n.~
--VictFound   $n nogs you.~
--CharAuto    You nog yourself. Prevert!~
--OthersAuto  $n nogs $kself. What a pervert!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        noogie~
...
--OthersFound $n grinds $l knuckles into the top of $n's head.~
--VictFound   $n grinds $l knuckles into the top of your head with glee.~
--CharAuto    Doesn't that hurt?~
--OthersAuto  $n grinds $l knuckles into $l head, oblivious to the pain.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        nose~
--CharNoArg   You wiggle your nose.~
--OthersNoArg $n wiggles $l nose.~
--CharFound   You tweak $l nose.~
--OthersFound $n tweaks $n's nose.~
--VictFound   $n tweaks your nose.~
--CharAuto    You tweak your own nose!~
--OthersAuto  $n tweaks $l own nose!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        nudge~
--CharNoArg   Nudge whom?~
--CharFound   You nudge $k.~
--OthersFound $n nudges $n.~
--VictFound   $n nudges you.~
--CharAuto    You nudge yourself, for some strange reason.~
--OthersAuto  $n nudges $kself, to keep $kself awake.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        nuzzle~
--CharNoArg   Nuzzle whom?~
--CharFound   You nuzzle $l neck softly.~
--OthersFound $n softly nuzzles $n's neck.~
--VictFound   $n softly nuzzles your neck.~
--CharAuto    I'm sorry, fri#SOCIAL_END~, but that's impossible.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        ogle~
--CharNoArg   Whom do you want to ogle?~
--CharFound   You ogle $k like $j was a piece of meat.~
--OthersFound $n ogles $n.  Maybe you should leave them alone for awhile?~
--VictFound   $n ogles you.  Guess what $j is thinking about?~
--CharAuto    You ogle yourself.  You may just be too weird for this mud.~
--OthersAuto  $n ogles $kself.  Better hope that $j stops there.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        ohno~
...
--CharFound   You exclaim to $k, 'Oh no!  I did it again!'~
...
--OthersAuto  $n exclaims to $kself, 'Oh no!  I did it again!'~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        oink~
...
--VictFound   $n looks at you and bellows 'Ooooink!'  $j must think you are a pig!~
--CharAuto    You start thinking that you are acting like a pig, stop that!~
--OthersAuto  $n thinks that $j is acting like a pig!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        ooo~
...
--OthersNoArg $n puts $l finger in $l mouth and says, "Oopsie! Did I do that?"~
...
--OthersAuto  $n wants to oops $kself. $n must be delusional.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        ouch~
...
--OthersNoArg $n turns $l head around in a circle and asks "Who? Who? Who?"~
--CharFound   You turn your head around in a circle and ask $n "Who? Who? Who?"~
--OthersFound $n turns $l head around in a circle and asks "Who? Who? Who?"~
--VictFound   $n turns $l head around in a circle and asks you, "Who? Who? Who?"~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        pace~
--CharNoArg   You pace around the Space in agitation.~
--OthersNoArg $n paces around the Space with an agitated expression.~
--CharFound   You pace around $n, wearing a path around $k.~
...
--OthersAuto  $n paces around $kself, looking rather dizzy.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        pant~
...
--OthersNoArg $n removes $l pants.~
--CharFound   You politely ask $n to remove $l pants.~
--OthersFound $n politely asks $n to remove $l pants.~
...
--OthersAuto  $n hastily puts on $l pants.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        passout~
--CharNoArg   You totter for a bit, then fall flat on your face.~
--OthersNoArg $n totters a bit and passes out flat on $l face.~
...
--OthersAuto  $n tries to catch $kself as $j passes out, but fails miserably.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        pat~
--CharNoArg   Pat whom?~
--CharFound   You pat $n on $l back.~
--OthersFound $n pats $n on $l back.~
--VictFound   $n pats you on your back.~
--CharAuto    You pat yourself on your back.~
--OthersAuto  $n pats $kself on the back.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        peck~
...
--CharFound   You give $k a little peck on the cheek.~
...
--OthersAuto  $n pecks $kself on $l pectoral muscles.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        peer~
...
--CharFound   You peer at $k quizzically.~
...
--OthersNoArg $n wipes $l brow with obvious relief.~
--CharFound   You share your obvious relief with $k.~
--OthersFound $n glances at $n, a look of obvious relief on $l face.~
--VictFound   $n glances at you, a look of obvious relief on $l face.~
--CharAuto    You mutter to yourself in obvious relief, wiping your brow.~
--OthersAuto  $n mutters in obvious relief, wiping $l brow.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        pinch~
...
--OthersAuto  $n pinches $kself. Now that's lonely!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        point~
--CharNoArg   Point at whom?~
--CharFound   You point at $k accusingly.~
--OthersFound $n points at $n accusingly.~
--VictFound   $n points at you accusingly.~
--CharAuto    You point proudly at yourself.~
--OthersAuto  $n points proudly at $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        poke~
--CharNoArg   Poke whom?~
--CharFound   You poke $k in the ribs.~
...
--OthersAuto  $n pokes $kself in the ribs, looking very sheepish.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        ponder~
...
--CharFound   You pounce on $n, pinning $k to the ground.~
--OthersFound $n pounces on $n, pinning $k to the ground.~
--VictFound   $n pounces on you, pinning you to the ground.~
--CharAuto    You try pouncing on yourself, but it doesn't quite work.~
--OthersAuto  $n tries to pounce on $kself, but it doesn't quite work.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        pout~
...
--OthersFound $n pouts at the way $j is being treated by $n.~
--VictFound   $n pouts at the way you are treating $k.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        pray~
...
--CharFound   You crawl in the dust before $k.~
...
--OthersAuto  $n mumbles a prayer to $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        propose~
...
--OthersFound $n drops to $l knees and begs $n to take $l hand in marriage!~
--VictFound   $n drops to one knee and begs you to become $l significant other for all eternity!~
--CharAuto    You love yourself so much that you would marry yourself if you could.~
--OthersAuto  $n loves $kself far too much.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        puke~
...
--OthersAuto  $n emptied $l stomach here and has left the Space ankle deep in puke!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        pulse~
--CharNoArg   A vein in your head begins to pulse as you feel a killer headache begin to form.~
--OthersNoArg A vein begins to bulge on $n's forehead.  $j looks stressed!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        punch~
--CharNoArg   Punch whom?~
--CharFound   You punch $k playfully.~
--OthersFound $n punches $n playfully.~
--VictFound   $n punches you playfully.  OUCH!~
--CharAuto    You punch yourself.  You deserve it.~
--OthersAuto  $n punches $kself.  Why don't you join in?~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        purr~
...
--OthersNoArg $n raises $l hand in response.~
--CharFound   You raise your hand in response.~
--OthersFound $n raises $l hand in response.~
--VictFound   $n raises $l hand in response to you.~
--CharAuto    You raise your hand in response.~
--OthersAuto  $n raises $l hand in response.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        rampage~
...
--OthersAuto  $n rampages all over $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        rant~
...
--OthersAuto  $n rants and raves at $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        ready~
...
--OthersFound $n begs $n to conjure some squeakies.  Shrink recomm#SOCIAL_END~ations?~
--VictFound   $n grovels at your boots, drooling rabidly in hopes of squeakies.~
--CharAuto    Not even a mouse...~
--OthersAuto  $n desperately scours the Space in pursuit of those elusive squeakies.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        ridicule~
...
--OthersAuto  Feeling foolish, $n laughs sheepishly at $lelf.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        roar~
...
--OthersAuto  $n ROARS loudly to establish $l dominance.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        rofl~
...
--CharFound   You laugh your head off at $l remark.~
...
--OthersAuto  $n laughs at $kself.  Join in the fun.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        roll~
--CharNoArg   You roll your eyes.~
--OthersNoArg $n rolls $l eyes.~
--CharFound   You roll your eyes at $k.~
--OthersFound $n rolls $l eyes at $n.~
--VictFound   $n rolls $l eyes at you.~
--CharAuto    You roll your eyes at yourself.~
--OthersAuto  $n rolls $l eyes at $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        rub~
--CharNoArg   You rub your eyes.  How long have you been at this?~
--OthersNoArg $n rubs $l eyes.  $n must have been playing all day.~
--CharFound   You rub your eyes.  Has $n been playing as long as you have?~
--OthersFound $n rubs $l eyes.  $n must have been playing all day.~
--VictFound   $n rubs $l eyes.  Have you been playing as long as $k?~
--CharAuto    You rub your eyes.  How long have you been at this?~
--OthersAuto  $n rubs $l eyes.  $n must have been playing all day.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        ruffle~
...
--OthersAuto  $n looks like $j's about to run away.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        sad~
...
--CharFound   You give $k your best glum expression.~
...
--OthersAuto  $n bows $l head and twists $l toe in the dirt glumly.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        salute~
...
--CharFound   You whip out a samwich and give it to $n. Maybe $j will like you now.~
--OthersFound $n whips out a samwhich and gives it to $n. $n hopes $j will like $k now.~
--VictFound   $n whips out a samwhich and gives it to you. $n hopes you will like $k now.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        scowl~
...
--CharFound   ARRRRRRRRRRGH!!!!!  Yes, it MUST have been $l fault!!!~
...
--OthersAuto  $n screams loudly at $kself!  Is there a full moon up?~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        serenade~
...
--OthersNoArg $n is ashamed of $kself.~
...
--OthersFound $n attempts to make $n close $l mouth in the interest of peace.~
--VictFound   $n has asked you to please be quiet.~
--CharAuto    You remind yourself to shaddup.~
--OthersAuto  $n oddly tells $kself to be quiet. Those darn voices again.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        shiver~
...
--CharFound   You shiver at the thought of fighting $k.~
...
--OthersAuto  $n scares $kself to shivers.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        shopping~
--CharNoArg   You announce it's time to go shopping. All the males flee the Space!~
--OthersNoArg $n announces it's time to go shopping. All the males flee the Space!~
--CharFound   You tell $n it's time to go shopping. All the males flee the Space!~
--OthersFound $n tells $n it's time to go shopping. All the males flee the Space!~
--VictFound   $n tells you it's time to go shopping. All the males flee the Space!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        shrug~
...
--CharFound   You shrug in response to $l question.~
...
--OthersAuto  $n shrugs to $kself.  What a strange person.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        shudder~
--CharNoArg   Your body shivers in uncontrollable revulsion.~
--OthersNoArg $n convulses as $j shudders in disgust.~
...
--OthersAuto  $n shudders with repulsion as $j thinks of $l behavior.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        sigh~
...
--CharFound   You sigh as you think of $k.~
--OthersFound $n sighs at the sight of $n.~
--VictFound   $n sighs as $j thinks of you.  Touching, huh?~
--CharAuto    You sigh at yourself.  You MUST be lonely.~
--OthersAuto  $n sighs at $kself.  What a sorry sight.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        silly~
--CharNoArg   You announce that you are just a big old silly.~
--OthersNoArg $n announces that $j is just a big old silly.~
...
--Name        slap~
--CharNoArg   Slap whom?~
--OthersNoArg $n raises $l hand spastically as if to slap an unseen annoyance.~
--CharFound   You rear back and slap $k with all your might.~
--OthersFound $n rears back and slaps $n for $l stupidity.~
--VictFound   $n rears back and slaps you cruelly for your stupidity.  OUCH!~
--CharAuto    You slap yourself.  You deserve it.~
--OthersAuto  $n slaps $kself.  Why don't you join in?~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        slaughter~
...
--CharFound   You slobber all over $k.~
--OthersFound $n slobbers all over $n.~
--VictFound   $n slobbers all over you.~
--CharAuto    You slobber all down your front.~
--OthersAuto  $n slobbers all over $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        slurp~
--CharNoArg   Slurp! Slurp!~
--OthersNoArg $n slurps $l drink noisily.~
--CharFound   You slurp $n!~
--OthersFound $n takes $n's face into $l hands and slurps $k! ~
...
--OthersAuto  $n tries to smite $kself. Fortunately, the Gods intervened just in time.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        smooch~
...
--CharFound   You give $k a nice, wet smooch.~
...
--OthersNoArg $n grins as if $l thoughts are mischevious.~
...
--CharFound   You snicker with $k about your shared secret.~
...
--OthersAuto  $n snickers at $l own evil thoughts.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        sniff~
...
--CharFound   You sniff sadly at the way $j is treating you.~
--OthersFound $n sniffs sadly at the way $n is treating $k.~
--VictFound   $n sniffs sadly at the way you are treating $k.~
--CharAuto    You sniff sadly at your lost opportunities.~
--OthersAuto  $n sniffs sadly at $kself.  Something MUST be bothering $k.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        snore~
...
--OthersNoArg $n sticks $l head under water and blows bubbles out of $l nose.~
--CharFound   You invite $n to go snorkeling with you.~
--OthersFound $n invites $n to go snorkling with $k.~
--VictFound   $n invites you to go snorkeling with $k.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        snort~
...
--OthersAuto  $n throws a snowball at $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        snuggle~
--CharNoArg   Who?~
--CharFound   you snuggle $k.~
...
--OthersNoArg $n tries to smile, but has $l fingers on the wrong keys.~
--CharFound   You try to smile at $n, but have your fingers on the wrong keys.~
--OthersFound $n attempts to smile at $n, but has $l fingers on the wrong keys!~
--VictFound   $n attempts to smile at you, but has $l fingers on the wrong keys!~
--CharAuto    You snuke yourself.~
--OthersAuto  $n snukes $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        social~
...
--OthersFound $n hurls a can of Spam at $n. Silly $n ... $j thinks that is spamming.~
--VictFound   $n hurls a can of Spam at you. What a fool! I bet $j thinks $j is spamming you.~
...
--CharFound   You spin $k on one finger.~
--OthersFound $n spins $n on $l finger.~
--VictFound   $n spins you around on $l finger.~
--CharAuto    You spin yourself around and around and around....~
--OthersAuto  $n spins $kself around and around and around...~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        spit~
...
--OthersAuto  $n spits into the wind. Unfortunately the wind is blowing towards $k.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        spum~
--CharNoArg   You are so spammed you are now spummed.~
--OthersNoArg $n is so spammed $j is now spummed.~
--CharFound   You spam $n so much $j is now spummed.~
--OthersFound $n spams $n so hard $j is now spummed.~
...
--CharFound   You squeak at $k.~
--OthersFound $n squeaks at $n.  Is $j a man or a mouse?~
--VictFound   $n squeaks at you.  Is $j a man or a mouse?~
--CharAuto    You squeak at yourself like a mouse.~
--OthersAuto  $n squeaks at $kself like a mouse.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        squeal~
...
--OthersAuto  $n squeals at $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        squeeze~
--CharNoArg   Where, what, how, whom?~
--CharFound   You squeeze $k fondly.~
--OthersFound $n squeezes $n fondly.~
--VictFound   $n squeezes you fondly.~
--CharAuto    You squeeze yourself - try to relax a little!~
--OthersAuto  $n squeezes $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        squint~
--CharNoArg   Bright light! Bright light!~
--OthersNoArg $n hides $l wee pupils from Ra's menacing globe.~
--CharFound   $n glows with energy!~
--OthersFound $n hides $l wee pupils from $n's radiant aura.~
--VictFound   $n hides $l wee pupils from your radiant aura.~
--CharAuto    You attempt to invert your eyeballs.  That's GOTTA hurt.~
--OthersAuto  $n tries to hide $l wee pupils from themself.  They glow with strangeness!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        squirm~
--CharNoArg   You squirm guiltily.~
--OthersNoArg $n squirms guiltily.  Looks like $j did it.~
--CharFound   You squirm in front of $k.~
--OthersFound $n squirms in front of $n.~
--VictFound   $n squirms in front of you.  You make $k nervous.~
...
--OthersNoArg $n squishes $l toes into the sand.~
--CharFound   You squish $k between your legs.~
--OthersFound $n squishes $n between $l legs.~
--VictFound   $n squishes you between $l legs.~
--CharAuto    You squish yourself.~
--OthersAuto  $n squishes $kself.  OUCH.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        stare~
...
--CharFound   You stare dreamily at $n, completely lost in $l eyes..~
...
--OthersAuto  $n stares dreamily at $kself - NARCISSIST!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        steam~
--CharNoArg   You are so angry that two sharp blasts of steam come whistling out of your ears.~
--OthersNoArg $n is so angry that two sharp blasts of steam come whistling out of $l ears.~
--CharFound   You are so angry at $n that two sharp blasts of steam come whistling out of your ears.~
--OthersFound $n is so angry at $n that two sharp blasts of steam come whistling out of $l ears!~
--VictFound   $n is so angry at you that two sharp blasts of steam come whistling out of $l ears!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        stomp~
--CharNoArg   You stomp your feet and pout like the baby you are.~
--OthersNoArg $n stomps $l feet and throws a tantrum like a baby.~
--CharFound   $n kicks $l feet on the ground for what $n did to $l.~
--OthersFound $n stomps $l feet and throws a tantrum at $n.~
--VictFound   $n stomps $l feet like a baby.~
...
--CharFound   You begin to pelt $k with large stones.~
...
--OthersNoArg $n struts, thinking $j's far too sexy for this mud.~
--CharFound   You strut to get $l attention.~
...
--OthersAuto  $n struts to $kself, lost in $l own world.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        stud~
--CharNoArg   You strike a pose in your most studly style!~
--OthersNoArg $n strikes a pose in $l most studly style!~
...
--#SOCIAL~
--Name        stuff~
--CharNoArg   You stuff your imaginary fri#SOCIAL_END~ into an extradimensional portal.~
--OthersNoArg $n stuffs $l imaginary fri#SOCIAL_END~ into an extradimensional portal.~
--CharFound   You stuff $n into an extradimensional portal...where $j belongs.~
--OthersFound $n stuffs $n into an extradimensional portal...where $j belongs.~
...
--OthersNoArg $n is suffering.  Looks like $j can't seem to level.~
--CharFound   You tell $k how you suffer whenever you're away from $k.~
--OthersFound $n tells $n that $j suffers whenever they're apart.~
--VictFound   $n tells you that $j suffers whenever you're apart.~
--CharAuto    No xp again?  You suffer at the hands of fate.~
--OthersAuto  $n is suffering.  Looks like $j can't seem to level.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        sulk~
...
--OthersNoArg $n looks for $l sweetie but cannot find them.~
...
--CharFound   You swoon in ecstacy at the thought of $k.~
--OthersFound $n swoons in ecstacy at the thought of $n.~
--VictFound   $n swoons in ecstacy as $j thinks of you.~
...
--CharFound   You run over to $k and bring $k down!~
--OthersFound $n runs over to $n and tackles $k to the ground!~
...
--OthersAuto  $n wraps $l arms around $kself and brings $kself down!?~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        tag~
...
--OthersAuto  $n dodges $l left hand, but is led directly into $l right!  Fool!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        tamale~
...
--OthersNoArg $n taps $l foot impatiently.~
--CharFound   You tap your foot impatiently.  Will $j ever be ready?~
--OthersFound $n taps $l foot impatiently as $j waits for $n.~
--VictFound   $n taps $l foot impatiently as $j waits for you.~
--CharAuto    You tap yourself on the head.  Ouch!~
--OthersAuto  $n taps $kself on the head.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        taunt~
...
--CharFound   You taunt $k. Hope $j doesn't make you do it a second time!~
...
--OthersAuto  $n attempts to taunt $kself. Perhaps $j needs help?~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        teapot~
...
--OthersFound $n gets $l hands in position and beings doing the teapot dance.~
--VictFound   $n puts $l hands in position and begins singing "I'm a little teapot, short and stout", to you.~
...
--CharFound   You tease $k playfully.~
--OthersFound $n is such a tease!~
--VictFound   $n teases you playfully.~
--CharAuto    You attempt to tease yourself. Pick on someone else!~
--OthersAuto  $n tries to tease $kself. What a loon.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        tee~
--CharNoArg   You say "tee hee" showing off your cute dimples.~
--OthersNoArg $n shows off $l cute dimples saying, "tee hee".~
--CharFound   You show off your cute dimples to $n saying, "tee hee".~
--OthersFound $n shows of $l cute dimples to $n saying, "tee hee".~
--VictFound   $n shows off $l cute dimples to you saying, "tee hee".~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        temple~
--CharNoArg   You want to do what?? And to whom??~
--CharFound   You begin to rub $l temples, attempting to reduce $l stress.~
--OthersFound $n begins to rub $n's temples... $j begins to relax.~
...
--OthersAuto  $n rubs $l temples, looking rather impatient.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        t#SOCIAL_END~ril~
--CharNoArg   You reach up and move a stray strand of hair from your eyes.~
--OthersNoArg $n reaches up to remove a stray whisp of hair from $l eyes.~
...
--OthersAuto  $n casually flips the hair from in front of $l eyes~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        thank~
...
--OthersAuto  $n thanks $kself since you won't.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        throttle~
--CharNoArg   Whom do you want to throttle?~
--CharFound   You throttle $k till $j is blue in the face.~
--OthersFound $n throttles $n about the neck, until $j passes out.  THUNK!~
--VictFound   $n throttles you about the neck until you pass out.  THUNK!~
--CharAuto    That might hurt!  Better not do it!~
--OthersAuto  $n is getting a crazy look in $l eye again.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        thwap~
...
--OthersAuto  $n thwaps $kself for being a moron.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        tickle~
...
--OthersFound $n tingles with delight as $j is graced with a smile from $n.~
--VictFound   $n stares at you with a warm, tingly look on $l face! You slowly back away..~
...
--#SOCIAL~
--Name        tipcap~
--CharNoArg   You tip your cap to everyone in the Space.~
--OthersNoArg $n tips $l cap to everyone in the Space.~
--CharFound   You tip your cap to $n.~
--OthersFound $n tips $l cap to $n. My how chivalrous!~
--VictFound   $n tips $l cap to you. My how chivalrous!~
--CharAuto    You tip your cap to yourself, hoping someone may take the hint and acknowledge your presence.~
--OthersAuto  $n tips $l cap to $kself, hoping in vain to have $l presence acknowledged.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        tissue~
...
--CharFound   You give $k a tissue. Awwww.~
...
--CharFound   You give $k a soft, t#SOCIAL_END~er kiss.~
--OthersFound $n gives $n a soft, t#SOCIAL_END~er kiss.~
--VictFound   $n gives you a soft, t#SOCIAL_END~er kiss.~
...
--OthersNoArg $n sticks $l tongue out.  How juvenile of $k!~
--CharFound   You stick out your tongue at $n.  How impressed $j is with you now!~
--OthersFound $n sticks $l tongue out at $n, apparently thinking this will impress $k.  Whadda jerk!~
--VictFound   $n sticks $l tongue out at you, apparently thinking it will impress you.  Whadda fool!~
--CharAuto    You stick your tongue out. How childish!~
--OthersAuto  $n sticks $l tongue out. How juveneille of $k!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        torture~
--CharNoArg   You have to torture someone!~
--CharFound   You torture $k with rusty weapons, Mwaahhhhh!!~
--OthersFound $n tortures $n with rusty weapons, $j must have been REAL bad!~
...
--OthersAuto  $n tortures $kself with rusty weapons.  Looks like $j enjoys it!?~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        touche~
--CharNoArg   With a cry of 'TOUCHE!' you smite your imaginary opponent.~
--OthersNoArg $n waves $l sword around in the air, doing $l Zorro impression or something.~
--CharFound   You touch your sword to $l chest and say 'Touche!'~
--OthersFound $n touches $l sword to $n's chest and says 'Touche!'~
--VictFound   $n touches $l sword to your chest and says 'Touche!'~
--CharAuto    With an amazing flourish of steel, you drive your sword into your own chest.~
--OthersAuto  $n drives $l sword into $l own chest and gurgles, 'Touche..' before falling dead.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        tralala~
...
--VictFound   $n looks at you, shakes $l head and says 'tsk tsk tsk'.~
...
--OthersNoArg $n is looking for someone to tuck $k in.~
--CharFound   You smile at $n and tuck $k into bed.~
--OthersFound $n smiles at $n and tucks $k into bed.~
--VictFound   $n tucks you into bed and smiles at you.~
--CharAuto    You tuck yourself into a ball and roll across the Space.~
--OthersAuto  $n tucks $kself into a ball and rolls across the Space.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        tummy~
--CharNoArg   You rub your tummy and wish you'd bought a pie at the bakery.~
--OthersNoArg $n rubs $l tummy and wishes $j'd bought a pie at the bakery.~
--CharFound   You rub your tummy and ask $k for some food.~
--OthersFound $n rubs $l tummy and asks $n for some food.~
--VictFound   $n rubs $l tummy and asks you for some food.  Please?~
--CharAuto    You rub your tummy and wish you'd bought a pie at the bakery.~
--OthersAuto  $n rubs $l tummy and wishes $j'd bought a pie at the bakery.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        turkey~
...
--OthersNoArg $n pulls $l head back into $l shell.~
--CharFound   You pull your head back into your shell in an effort to hide from $n.~
--OthersFound $n pulls $l head back into $l head in an effort to hide from $n.~
--VictFound   $n pulls $l head back into $l shell in an effort to hide from you.~
--CharAuto    You want to turn into a turtle? Try building a cocoon!~
--OthersAuto  $n wants to be a turtle. Perhaps $j should build a cocoon!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        twiddle~
--CharNoArg   You patiently twiddle your thumbs.~
--OthersNoArg $n patiently twiddles $l thumbs.~
--CharFound   You twiddle $l ears.~
--OthersFound $n twiddles $n's ears.~
--VictFound   $n twiddles your ears.~
--CharAuto    You twiddle your ears like Dumbo.~
--OthersAuto  $n twiddles $l own ears like Dumbo.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        twitch~
...
--OthersNoArg $n scratches $l head and says, "Ugggggh, I should know this."~
...
--VictFound   $n covers $l eyes and runs off screaming, "UGGGGGH!", after looking at you.~
--CharAuto    You ugh at yourself in contempt.~
--OthersAuto  $n catches a glimpse of $lelf in a mirror and screams, "UGGGGGGGGH"!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        uplift~
--CharNoArg   You summon a mystical hand to provide aid.~
--OthersNoArg $n tries to summon a mystical hand to do $l bidding.~
--CharFound   You summon a healing hand for $n, but it backfires! A demon hand appears and begins to thrash $k about the head repeatedly!~
...
--OthersAuto  You watch in horror as the mystical hand is summoned by $n.  The spell backfires and the hand begins to beat $k senseless!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        vbite~
--CharNoArg   You bare your fangs.~
--OthersNoArg $n bares $l fangs and peers around nonchalantly.~
--CharFound   You sensually brush $n's neck with your lips before sucking $l blood!~
--OthersFound $n softly brushes $n's neck with $l lips, and then BITES!~
--VictFound   $n bites your neck! Ouchhhh!~
--CharAuto    Now, if you could bite your own neck..I'd worry.~
--OthersAuto  $n is in danger of hurting $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        village~
--CharNoArg   You know there's a village idiot in every village. Why can't you find it here?? You boggle.~
--OthersNoArg $n searches for the town imbecile in vain. You notice the "Village Idiot" sign attached to $l armor.~
...
--OthersAuto  $n prances around proclaiming $kself village idiot!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        waddle~
--CharNoArg   You waddle around, imitating a penguin.~
--OthersNoArg $n waddles around imitating a penguin.  Maybe $j will squawk next!~
--CharFound   You waddle at $n, like a penguin!~
--OthersFound $n waddles at $n like a penguin! Maybe $j will squawk next!~
--VictFound   $n waddles at you like a penguin! Maybe $j will squawk next!~
--CharAuto    You waddle at yourself like a penguin! Feeling alright?~
--OthersAuto  $n waddles at $kself like a penguin! Wonder if $j is feeling alright.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        waggle~
--CharNoArg   You waggle your finger at nothing! Feeling delusional?~
--OthersNoArg $n waggles $l finger at nothing.  Is $j feeling ok?~
--CharFound   You waggle your finger at $n.  What did $j do?~
--OthersFound $n waggles $l finger at $n, for some reason.~
--VictFound   $n waggles $l finger at you! What did you do?'~
--CharAuto    You waggle your finger at yourself! Have you lost it?~
--OthersAuto  $n waggles $l finger at $kself! $j is really gone now...~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        wave~
...
--OthersAuto  $n waves goodbye to $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        wedgie~
...
--OthersAuto  $n pulls $l leggings up violently! --Kinky!!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        weep~
...
--OthersFound $n begins to weep uncontrollably. What has $n done to make $k so unconsolable?~
--VictFound   $n begins to weep uncontrollably. What have you done to $k?~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        what~
...
--OthersFound $n is so happy to see $n that $j jumps into the air and hollers, "Wheeeeee!"~
--VictFound   $n is so happy to see you that $j jumps into the air and hollers, "Wheeeeee!"~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        when~
...
--#SOCIAL~
--Name        whimper~
--CharNoArg   You whimper loud enough for the entire Space to hear.~
...
--CharFound   You whine to $k like the great whiners of the century.~
...
--CharFound   You whistle at the sight of $k.~
...
--OthersAuto  $n whistles a little tune to $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        why~
...
--OthersNoArg $n's face lights up as $j exclaims, "Wicked!"~
...
--OthersNoArg $n wiggles $l bottom.~
--CharFound   You wiggle your bottom toward $k.~
--OthersFound $n wiggles $l bottom toward $n.~
--VictFound   $n wiggles $l bottom towards you.~
...
--OthersAuto  $n winks at $kself - something strange is going on...~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        witch~
--CharNoArg   You announce to all that you are indeed a witch!~
--OthersNoArg $n announces that $j is a witch. You wonder where that frog came from.~
--CharFound   You whisper to $n that you are a witch. $n is afraid you will turn $k into a frog.~
--OthersFound $n informs $n that $j is a witch and is trying to remember the spell to turn $n into a frog.~
--VictFound   $n informs you $j is a witch and is trying to remember the spell to turn you into a frog.~
--CharAuto    You think you are a witch? Hmmm ... you could be right.~
--OthersAuto  $n thinks $j is a witch and $j probably is right.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        women~
--CharNoArg   You wonder why women go to the bathSpace together.~
...
--OthersAuto  $n tries to figure out women, get back to $k in a couple hundred years.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        woof~
...
--CharFound   You drop to your knees in homage of $k.~
--OthersFound $n prostrates $kself before $n.~
--VictFound   $n believes you are all powerful.~
--CharAuto    You worship yourself.~
--OthersAuto  $n worships $kself - ah, the conceitedness of it all.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        wriggle~
--CharNoArg   You wriggle your toes for all to see. Oooh! You sexy thing!~
--OthersNoArg $n wriggles $l toes for all to see. Oooh! What a sexy thing!~
--CharFound   You wriggle your sexy toes for $n. Ooooh! You sexy thing!~
--OthersFound $n wriggles $l toes for $n. Oooh! What a sexy thing $j is!~
--VictFound   $n wriggles $l toes for you. Oooh. What a sexy thing $j is!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        xena~
--CharNoArg   You make like Xena and puff out your chest!~
--OthersNoArg $n makes like Xena and puffs out $l chest.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        yabba~
...
--OthersNoArg $n yawns.~
--CharFound   You yawn widely in the middle of $l sentence.~
...
--OthersAuto  $n yawns, apparently boring even $kself.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        yoga~
...
--OthersAuto  $n jumps up in the air and begins to  yoga fly around the Space.~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        yoyo~
...
--OthersAuto  $n wishes $j was a yoyo. $n is a nutbar!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        yummy~
--CharNoArg   Your rub your tummy and say "Yummy!".~
--OthersNoArg $n rubs $l tummy and exclaims, "Yummy!"~
...
--OthersAuto  $n thinks $j is yummy. How conceited!~
--#SOCIAL_END~
--
--#SOCIAL~
--Name        zombie~
--CharNoArg   You shuffle through the Space, a dazed look on your face, gurgling randomly.  Maybe it's time to log off...~
--OthersNoArg $n shuffles through the Space, a dazed look on $l face, gurgling randomly. Maybe it's time to logoff...~
...
--VictFound   $n eyes $n hungrily, and utters the word 'Braaaaiiiinnnnnsss...' Better leave before $j turns on you...~
--CharAuto    You look into the mirror and see a hallow eyed, slack jawed, drooling, sleep deprived creature staring back at you.~
--OthersAuto  $n wanders around the Space, a slack jawed, drooling, sleep deprived creature, mumbling something about brains...~
--#SOCIAL_END~
