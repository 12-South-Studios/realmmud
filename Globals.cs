...
namespace Realm.Globals
{
    ...
    public static class Globals
    {
        ...
        public enum BitTypes
        {
            ...
            [Enum("Behavior Bits", 13)]
            BehaviorBits,

            [Enum("Game Command Bits", 14)]
            GameCommandBits,
        ...
        public enum EffectTypes
        {
            ...
            [Enum("Change Position", 3)]
            ChangePosition,

            [Enum("Damage Shield", 4)]
            DamageShield,
            ...
            [Enum("Health Change", 9)]
            HealthChange,

            [Enum("Health Change-Over-Time", 10)]
            HealthChangeOverTime,

            [Enum("Space Effect", 11)]
            SpaceEffect,

            [Enum("StatMod", 12)]
            StatMod,

            [Enum("StatMod Change-Over-Time", 13)]
            StatModChangeOverTime,

            [Enum("Status Effect", 14)]
            StatusEffect,

            [Enum("Teleport", 15)]
            Teleport,

            [Enum("Temporary Entity", 16)]
            TemporaryEntity,

            [Enum("Timed Effect", 17)]
            TimedEffect
        };
        ...
        {
            [Enum("Void", 1, "Void", "0;0;0")]
            Void,

            [Enum("Light", 2, "Light", "3;4;6")]
            Light,

            [Enum("Shadow", 3, "Shadow", "2;5;7")]
            Shadow,

            [Enum("Fire", 4, "Fire", "7;5;2")]
            Fire,

            [Enum("Earth", 5, "Earth", "6;4;3")]
            Earth,

            [Enum("Air", 6, "Air", "5;2;7")]
            Air,

            [Enum("Water", 7, "Water", "4;6;3")]
            Water
        };
        ...
        public enum MobileBits
        {
            ...
            [Enum("IsGuard", 16384, "IsGuard", "73;9")]
            IsGuard,

            [Enum("IsStatic", 32768, "IsStatic", "74;9")]
            IsStatic,

            [Enum("IsAnimal", 65536, "IsAnimal", "75;9")]
            IsAnimal,

            [Enum("IsUndead", 131072, "IsUndead", "76;9")]
            IsUndead,

            [Enum("IsElemental", 262144, "IsElemental", "77;9")]
            IsElemental
        };
