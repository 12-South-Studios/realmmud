...
namespace Realm.Data.Loaders
{
    ...
    ///
    /// </summary>
    public class SkillLoader : Loader<SkillDef>
    {
        /// <summary>
        ///
        /// </summary>
        ...
        public SkillLoader([Named("StaticDataLoader")]IEntity owner,  IDatabaseLoadBalancer loadBalancer,
            IStaticDataRepository staticDataRepository, string schema, ILogWrapper log)
            : base(owner, loadBalancer, staticDataRepository, log, schema, Globals.Globals.SystemTypes.Skill)
        {
        }
