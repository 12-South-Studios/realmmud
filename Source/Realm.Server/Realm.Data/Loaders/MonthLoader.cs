...
namespace Realm.Data.Loaders
{
    ...
    ///
    /// </summary>
    public class MonthLoader : Loader<MonthDef>
    {
        /// <summary>
        ///
        /// </summary>
        ...
        public MonthLoader([Named("StaticDataLoader")]IEntity owner,  IDatabaseLoadBalancer loadBalancer,
            IStaticDataRepository staticDataRepository, string schema, ILogWrapper log)
            : base(owner, loadBalancer, staticDataRepository, log, schema, Globals.Globals.SystemTypes.Month)
        {
        }
