...
namespace Realm.Data.Loaders
{
    ...
    ///
    /// </summary>
    public class ShopLoader : Loader<ShopDef>
    {
        /// <summary>
        ///
        /// </summary>
        ...
        public ShopLoader([Named("StaticDataLoader")]IEntity owner,  IDatabaseLoadBalancer loadBalancer,
            IStaticDataRepository staticDataRepository, string schema, ILogWrapper log)
            : base(owner, loadBalancer, staticDataRepository, log, schema, Globals.Globals.SystemTypes.Shop)
        {
        }
        ...
        public override bool Load(BooleanSet boolSet)
        {
            var commands = new Dictionary<string, string>
                               {
                                   {"game_GetShops", ""},
                                   {"game_GetShopBuyTypes", "BuyTypes"},
                                   {"game_GetShopPrimitives", "Primitives"}
                               };
