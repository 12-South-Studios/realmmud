...
namespace Realm.Data.Loaders
{
    ...
    ///
    /// </summary>
    public class BehaviorLoader : Loader<BehaviorDef>
    {
        /// <summary>
        ///
        /// </summary>
        ...
        public BehaviorLoader([Named("StaticDataLoader")]IEntity owner,  IDatabaseLoadBalancer loadBalancer,
            IStaticDataRepository staticDataRepository, string schema, ILogWrapper log)
            : base(owner, loadBalancer, staticDataRepository, log, schema, Globals.Globals.SystemTypes.Behavior)
        {
        }
