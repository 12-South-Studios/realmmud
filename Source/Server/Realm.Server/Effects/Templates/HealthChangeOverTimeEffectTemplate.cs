//// ----------------------------------------------------------------------
//// <copyright file="HealthChangeOverTimeEffectTemplate.cs" company="12-South Studios">
...
//{
//    public class HealthChangeOverTimeEffectTemplate : EffectTemplate
//    {
//        public HealthChangeOverTimeEffectTemplate(long id, string name)
//            : base(id, name)
//        {
//        }
...
//        {
//        //    base.OnInit();
//            EffectType = EnumerationExtensions.GetEnum<Globals.Globals.EffectTypes>("HealthChangeOverTime");
//        }
