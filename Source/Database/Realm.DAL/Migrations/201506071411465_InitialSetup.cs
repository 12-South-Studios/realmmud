namespace Realm.DAL.Migrations
{
    ...
    public partial class InitialSetup : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DisplayDescription = c.String(nullable: false, maxLength: 2048),
                ...
                c => new
                    {
                        ...
                        TargetSpaceId = c.Int(nullable: false),
                        BarrierId = c.Int(),
                        Bits = c.Int(nullable: false),
                        Keywords = c.String(nullable: false, maxLength: 255),
                        CreateDateUtc = c.DateTime(),
                ...
                c => new
                    {
                        ...
                        TerrainId = c.Int(nullable: false),
                        CreateDateUtc = c.DateTime(),
                        MoementMode_Id = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        CreateDateUtc = c.DateTime(),
                        PrimitiveId = c.Int(nullable: false),
                        Weight = c.Int(nullable: false),
        ...
        {
            DropForeignKey("dbo.Socials", "SystemClassId", "dbo.SystemClasses");
            DropForeignKey("dbo.Rituals", "TagSetId", "dbo.TagSets");
            DropForeignKey("dbo.Rituals", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Quests", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Months", "SystemClassId", "dbo.SystemClasses");
            DropForeignKey("dbo.MonthEffects", "MonthId", "dbo.Months");
            DropForeignKey("dbo.MonthEffects", "EffectId", "dbo.Effects");
            DropForeignKey("dbo.Helps", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.GameCommands", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Abilities", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Effects", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Zones", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Spawns", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Resets", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Shops", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Mobiles", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Treasures", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Items", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Races", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Archetypes", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Terrains", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Spaces", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Barriers", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.MudProgs", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.ItemSets", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Skills", "SystemClassId", "dbo.SystemClasses");
            DropForeignKey("dbo.Skills", "SkillCategoryId", "dbo.SkillCategories");
            DropForeignKey("dbo.SkillCategories", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Liquids", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Conversations", "SystemClassId", "dbo.SystemClasses");
            DropForeignKey("dbo.Conversations", "RequiredFactionId", "dbo.Factions");
            DropForeignKey("dbo.Factions", "TagSetId", "dbo.TagSets");
            DropForeignKey("dbo.Factions", "SystemClassId", "dbo.SystemClasses");
            ...
            DropForeignKey("dbo.Behaviors", "SystemClassId", "dbo.SystemClasses");
            ...
            DropIndex("dbo.Socials", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Rituals", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Quests", new[] { "SystemClassId" });
            DropIndex("dbo.MonthEffects", new[] { "MonthId" });
            DropIndex("dbo.MonthEffects", new[] { "EffectId" });
            DropIndex("dbo.Months", new[] { "SystemClassId" });
            DropIndex("dbo.Helps", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.GameCommands", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Spawns", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Resets", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Shops", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Treasures", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Races", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Archetypes", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Terrains", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Barriers", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.ItemSets", new[] { "SystemClassId" });
            DropIndex("dbo.ItemFurnitures", new[] { "ItemId" });
            DropIndex("dbo.SkillCategories", new[] { "SystemClassId" });
            DropIndex("dbo.Skills", new[] { "ParentSkillId" });
            DropIndex("dbo.Skills", new[] { "SkillCategoryId" });
            DropIndex("dbo.Skills", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Liquids", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Items", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Mobiles", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Zones", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Effects", new[] { "SystemClassId" });
            ...
            DropIndex("dbo.Abilities", new[] { "SystemClassId" });
